...
def common_sports(current_sports, favorite_sports)
    x = current_sports & favorite_sports
    p x
    #Only passes the test if the order is current_spots & favorite_sports
    #does not work if favorite_sports & current_sports because the order is different
    return x
end
